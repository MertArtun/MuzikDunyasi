        ...
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner rounded shadow">
                <div class="carousel-item active">
                    <img src="{{ asset('images/banners/main-banner.jpg') }}" class="d-block w-100" alt="Müzik Dünyası">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('images/banners/new-products.jpg') }}" class="d-block w-100" alt="Yeni Ürünler">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="{{ asset('images/banners/special-offers.jpg') }}" class="d-block w-100" alt="Özel İndirimler">
                    <div class="carousel-caption d-none d-md-block">
...
<div class="row mb-5">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow-sm category-card">
            <img src="{{ asset('images/categories/guitars.jpg') }}" class="card-img-top category-img" alt="Gitarlar">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow-sm category-card">
            <img src="{{ asset('images/categories/drums.jpg') }}" class="card-img-top category-img" alt="Davul ve Perküsyon">
            <div class="card-body text-center">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow-sm category-card">
            <img src="{{ asset('images/categories/audio.jpg') }}" class="card-img-top category-img" alt="Ses Ekipmanları">
            <div class="card-body text-center">
    ...
    <div class="col-md-3 mb-4">
        <div class="card h-100 border-0 shadow-sm product-card">
            ...
            <div class="card-body d-flex flex-column">
                <h5 class="card-title"><a href="{{ url('/products/' . $product->id) }}" class="text-decoration-none text-dark">{{ $product->name }}</a></h5>
                <p class="text-muted small">{{ $product->category->name ?? 'Kategorisiz' }}</p>
                <p class="card-text small flex-grow-1">{{ Str::limit($product->description, 70) }}</p>
                <div class="d-flex justify-content-between align-items-center mt-auto">
                    <span class="h5 mb-0 text-primary">{{ number_format($product->price, 2) }} ₺</span>
                    {{-- Sepete ekle butonu için link eklenecek --}}
...
<div class="row mb-5">
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm musician-story-card">
            <img src="{{ asset('images/musicians/musician1.jpg') }}" class="card-img-top musician-img" alt="Ahmet Yılmaz">
            <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm musician-story-card">
            <img src="{{ asset('images/musicians/musician2.jpg') }}" class="card-img-top musician-img" alt="Zeynep Kaya">
            <div class="card-body">
                <div class="musician-quote">
                    <i class="fas fa-quote-left"></i>
                </div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm musician-story-card">
            <img src="{{ asset('images/musicians/musician3.jpg') }}" class="card-img-top musician-img" alt="Burak Demir">
            <div class="card-body">
                <div class="musician-quote">
                    <i class="fas fa-quote-left"></i>
                </div>
        ...
        <div class="card h-100 border-0 shadow-sm testimonial-card">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <img src="{{ asset('images/testimonials/person1.jpg') }}" class="rounded-circle me-3 testimonial-img" alt="Müşteri">
                    <div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow-sm testimonial-card">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <img src="{{ asset('images/testimonials/person2.jpg') }}" class="rounded-circle me-3 testimonial-img" alt="Müşteri">
                    <div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow-sm testimonial-card">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <img src="{{ asset('images/testimonials/person3.jpg') }}" class="rounded-circle me-3 testimonial-img" alt="Müşteri">
                    <div>
...
<div class="row mb-5">
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm event-card" 
             data-event-image="{{ asset('images/events/event1.jpg') }}" 
            ...
            <img src="{{ asset('images/events/event1.jpg') }}" class="card-img-top event-img" alt="Canlı Performans Gecesi">
            <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm event-card"
             data-event-image="{{ asset('images/events/event2.jpg') }}" 
            ...
            <img src="{{ asset('images/events/event2.jpg') }}" class="card-img-top event-img" alt="Gitar Workshop">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm event-card"
             data-event-image="{{ asset('images/events/event3.jpg') }}" 
            ...
            <img src="{{ asset('images/events/event3.jpg') }}" class="card-img-top event-img" alt="Enstrüman Tanıtım Günü">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-2">
