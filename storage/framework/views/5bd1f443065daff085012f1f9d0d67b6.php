...
<head>
    ...
    <title><?php echo e(config('app.name', 'Müzik Dünyası')); ?></title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <?php if(auth()->guard()->guest()): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('login')); ?>">Giriş Yap</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('register')); ?>">Kayıt Ol</a>
                                </li>
                        <?php else: ?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start">
                        <p class="mb-0">&copy; <?php echo e(date('Y')); ?> Müzik Dünyası. Tüm hakları saklıdır.</p>
                    </div>
...
<?php /**PATH /Users/halitartun/Desktop/MuzikDunyasıTest/resources/views/layouts/app.blade.php ENDPATH**/ ?>