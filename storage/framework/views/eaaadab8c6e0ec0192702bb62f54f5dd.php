...
<nav aria-label="breadcrumb" class="mb-4">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Ürün Düzenle: <?php echo e($product->name); ?></li>
    </ol>
</nav>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Ürün Düzenle</h1>
    <div>
        <a href="<?php echo e(route('products.show', $product)); ?>" class="btn btn-info me-2" target="_blank">
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="5" required><?php echo e(old('description', $product->description)); ?></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card h-100">
                            <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" class="card-img-top" alt="<?php echo e($product->name); ?>" style="height: 150px; object-fit: cover;">
                            <div class="card-body text-center">
                                <h6 class="card-title">
                                    <?php if($image->is_primary): ?>
                                    <span class="badge bg-primary">Ana Görsel</span>
                                    <?php else: ?>
                                    <span class="badge bg-secondary">Görsel <?php echo e($loop->iteration); ?></span>
                                    <?php endif; ?>
                                </h6>
                                <div class="btn-group w-100" role="group">
                                    <?php if(!$image->is_primary): ?>
                                    <form action="<?php echo e(route('admin.products.images.primary')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('admin.products.images.delete', $image->id)); ?>" method="POST" onsubmit="return confirm('Bu görseli silmek istediğinize emin misiniz?')">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-secondary me-md-2">
...
<div class="card shadow mb-4 border-danger">
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <form action="<?php echo e(route('admin.products.destroy', $product)); ?>" method="POST" onsubmit="return confirm('UYARI: Bu ürünü silmek istediğinize emin misiniz? Bu işlem geri alınamaz!')">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/halitartun/Desktop/MuzikDunyasıTest/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>